---
name: example-test
description: "Create or maintain regression, contract, integration, and persistence-compatibility tests from observable requirements. Use for meaningful coverage or test-quality work, not coverage-number inflation."
---
...
Do not let tests silently approve their own changed expectations or snapshot baselines. Return the protected behavior and remaining gaps, not just a green summary.
